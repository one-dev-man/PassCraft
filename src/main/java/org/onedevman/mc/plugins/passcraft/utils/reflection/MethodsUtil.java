...
public class MethodsUtil {
    ...
    public static List<Method> filter(Object target, MethodFilter filter) {
        return filter(target, filter, false);
    }

    public static List<Method> filter(Object target, MethodFilter filter, boolean declared) {
        return filter(target.getClass(), filter, declared);
    }

    public static List<Method> filter(Class<?> target_class, MethodFilter filter) {
        return filter(target_class, filter, false);
    }

    public static List<Method> filter(Class<?> target_class, MethodFilter filter, boolean declared) {
