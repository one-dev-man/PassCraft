package org.onedevman.mc.plugins.passcraft.utils.resources;
...
public class ConfigParser {
    ...
    private void mapTokens() {
        ConfigurationSection token_section = this.config().getConfigurationSection(Locale.CONFIGPATHS.CONFIG_TOKENS);
